        ...
        try
        {
          ...
          while(rs.next()){
        	  ...
        	  MId = rs.getInt("MId");
                  ...
                  showingDate=rs.getString("date_");
          }
...
message+="Slot : "+slot+"\n";
message+="Venue : "+venue+"\n";
message+="Showing Date : "+showingDate+"\n";
          	...
          	case 1: if(slot==1)
          			...
          			if(!m.bookNew(number)){
          				...
          				int ticket_id=createTicket(conn,username,showId,num,clss,cost);
                                        htmlRespone += "<center><div style='border:1px solid black; border-radius:3px; width:400px;'><h2>Tickets Booked</h2><hr><br/><h3> Total Paid $" + cost + "</h3><br><hr><p>order: "+ number+" x " +clss+" tickets<br>Movie: "+name+"- ("+duration+" minutes)</p><h2>Screen: "+screen+"</h2><br><h2>Slot: "+slot+"</h2><h2>Venue: "+venue+"</h2><h2>Showing Date: "+showingDate+"</h2><br><h2>Ticket ID: "+ticket_id+"</h2></div></center>"; 
