        ...
        <tbody>
            ...
            %>
                ...
                <%
                 ...
                 String ticket_id = rs.getString("ticket_id"); //column 12 is ticket id
                 String venue = rs.getString("venue"); //column 12 is ticket id
                 String showingDate = rs.getString("date_"); //column 12 is ticket id
